...
var AppComponent = (function () {
    function AppComponent(auth, posts, router) {
        ...
        this.auth.getLoginEventEmitter()
            ...
            _this.posts.listPostsById(user._id)
                .subscribe(function (postlist) { _this.postlist = postlist; });
        });
    }
    ;
    ...
    AppComponent.prototype.gotoSearch = function () {
        this.searchText = __WEBPACK_IMPORTED_MODULE_4_jquery__("#search").val();
        this.router.navigate(["search/" + this.searchText]);
    };
    AppComponent.prototype.gotoProfile = function () {
        this.router.navigate(['user', this.user._id]);
    };
    AppComponent.prototype.gotoShelf = function () {
        this.router.navigate(['shelf', this.user._id]);
    };
    AppComponent.prototype.logout = function () {
        var _this = this;
        this.auth.logout().subscribe(function () { return _this.router.navigate(['login']); });
    };
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_isLoggedIn_canactivate_service__ = __webpack_require__("../../../../../src/app/services/isLoggedIn.canactivate.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__routes__ = __webpack_require__("../../../../../src/app/routes.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__signupform_signupform_component__ = __webpack_require__("../../../../../src/app/signupform/signupform.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__allposts_allposts_component__ = __webpack_require__("../../../../../src/app/allposts/allposts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__editprofile_editprofile_component__ = __webpack_require__("../../../../../src/app/editprofile/editprofile.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__makecomment_makecomment_component__ = __webpack_require__("../../../../../src/app/makecomment/makecomment.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__makepost_makepost_component__ = __webpack_require__("../../../../../src/app/makepost/makepost.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__seepost_seepost_component__ = __webpack_require__("../../../../../src/app/seepost/seepost.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__editpost_editpost_component__ = __webpack_require__("../../../../../src/app/editpost/editpost.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__seeuser_seeuser_component__ = __webpack_require__("../../../../../src/app/seeuser/seeuser.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__message_message_component__ = __webpack_require__("../../../../../src/app/message/message.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__shelf_shelf_component__ = __webpack_require__("../../../../../src/app/shelf/shelf.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__searches_searches_component__ = __webpack_require__("../../../../../src/app/searches/searches.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_14__signupform_signupform_component__["a" /* SignupformComponent */],
            __WEBPACK_IMPORTED_MODULE_15__allposts_allposts_component__["a" /* AllpostsComponent */],
            __WEBPACK_IMPORTED_MODULE_16__editprofile_editprofile_component__["a" /* EditprofileComponent */],
            __WEBPACK_IMPORTED_MODULE_17__makecomment_makecomment_component__["a" /* MakecommentComponent */],
            __WEBPACK_IMPORTED_MODULE_18__makepost_makepost_component__["a" /* MakepostComponent */],
            __WEBPACK_IMPORTED_MODULE_19__seepost_seepost_component__["a" /* SeepostComponent */],
            __WEBPACK_IMPORTED_MODULE_21__seeuser_seeuser_component__["a" /* SeeuserComponent */],
            __WEBPACK_IMPORTED_MODULE_20__editpost_editpost_component__["a" /* EditpostComponent */],
            __WEBPACK_IMPORTED_MODULE_22__message_message_component__["a" /* MessageComponent */],
            __WEBPACK_IMPORTED_MODULE_23__shelf_shelf_component__["a" /* ShelfComponent */],
            __WEBPACK_IMPORTED_MODULE_24__searches_searches_component__["a" /* SearchesComponent */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */],
            __WEBPACK_IMPORTED_MODULE_3__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_http__["a" /* HttpModule */],
            __WEBPACK_IMPORTED_MODULE_11__angular_router__["a" /* RouterModule */].forRoot(__WEBPACK_IMPORTED_MODULE_13__routes__["a" /* routes */])
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_7__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_12__services_isLoggedIn_canactivate_service__["a" /* IsLoggedInService */], __WEBPACK_IMPORTED_MODULE_8__services_posts_service__["a" /* PostsService */], __WEBPACK_IMPORTED_MODULE_9__services_books_service__["a" /* BooksService */]],
...
var MakepostComponent = (function () {
    ...
    MakepostComponent.prototype.goHome = function () {
        this.router.navigate(['/']);
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__shelf_shelf_component__ = __webpack_require__("../../../../../src/app/shelf/shelf.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__searches_searches_component__ = __webpack_require__("../../../../../src/app/searches/searches.component.ts");
...
var routes = [
    ...
    { path: 'search/:id', component: __WEBPACK_IMPORTED_MODULE_11__searches_searches_component__["a" /* SearchesComponent */] },
    ...
    { path: 'shelf/:id', component: __WEBPACK_IMPORTED_MODULE_10__shelf_shelf_component__["a" /* ShelfComponent */] },
    { path: 'messages/:id', component: __WEBPACK_IMPORTED_MODULE_9__message_message_component__["a" /* MessageComponent */] },
...
/***/ "../../../../../src/app/searches/searches.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".webTitle {\n  margin: 0 auto;\n  position: relative;\n  width: 40%;\n  text-align: center;\n  opacity: 0.8;\n  text-decoration: underline;\n  border-radius: 5px;\n  height: 65px;\n  margin-top: 25px;\n  border: 1px solid black;\n}\n\n.webTitle h2 {\n  margin: 0;\n}\n\n.searchContainer {\n  width: 50%;\n  margin: 0 auto;\n  margin-top: 35px;\n}\n\n.title {\n  text-align: center;\n  margin-top: 0;\n  padding: 5px;\n}\n\n.searchPortal {\n  padding: 7px;\n  border: 2px solid black;\n  opacity: 0.9;\n}\n\n.portalTitle {\n  text-align: center;\n}\n\n.none {\n  text-align: center;\n}\n\n.indivpost {\n  border: 1px solid black;\n  padding: 5px 20px;\n  margin: 5px;\n  text-align: center;\n}\n\n.credit {\n  font-size: 10px;\n}\n", ""]);
...
/***/ "../../../../../src/app/searches/searches.component.html":
/***/ (function(module, exports) {

module.exports = "<div class=\"col s4 webTitle white\">\n  <h2>{{title}}</h2>\n</div>\n\n<div class=\"searchContainer container\">\n  <div class=\"searchPortal col s8 container white\">\n    <div class=\"portalTitle\">\n      <h4>Search entries for \"{{search}}\"</h4>\n    </div>\n    <div class=\"none\" *ngIf=\"posts.length === 0\">\n      <p>No searches found for \"{{search}}\"</p>\n    </div>\n    <ul class=\"searchList hoverable indivpost indivpost{{post._id}} col s4\" *ngFor=\"let post of posts\">\n      <li class=\"title\"><b>{{post.title}}</b></li>\n      <li class=\"credit\"> Posted by: <a routerLink='/user/{{post.creator}}'>{{post.creator}}</a> on {{post.created_at1}} at {{post.created_at2}}</li>\n      <li class=\"content truncate\">{{post.content}}</li>\n      <div class=\"postLinks\">\n        <li><a routerLink=\"/post/{{post._id}}\">See post - {{post.comments.length}} comments</a></li>\n      </div>\n      <div class=\"seemore\" *ngIf=\"posts.length > 5\">\n        <a href=\"#\">See more</a>\n      </div>\n    </ul>\n  </div>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/searches/searches.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var SearchesComponent = (function () {
    function SearchesComponent(Post, route, router) {
        this.Post = Post;
        this.route = route;
        this.router = router;
        this.title = "aLitMatch";
    }
    SearchesComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.Post.search(params.id).subscribe(function (posts) {
                _this.posts = posts;
                _this.search = params.id;
...
SearchesComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/searches/searches.component.html"),
        styles: [__webpack_require__("../../../../../src/app/searches/searches.component.css")]
    }),
...
var SeepostComponent = (function () {
    ...
    SeepostComponent.prototype.ngOnInit = function () {
        ...
        this.route.params
            ...
            _this.Post.seePost(params.id).subscribe(function (post) {
                _this.post = post;
                _this.post.created_at1 = _this.post.created_at.slice(0, 10);
                _this.post.created_at2 = _this.post.created_at.slice(11, 19);
    ...
    SeepostComponent.prototype.delete = function (post) {
        var _this = this;
...
var AuthService = (function () {
    ...
    AuthService.prototype.login = function (user) {
        ...
        return this.http.post(BASEURL + "/login", user, this.options)
            .map(function (res) { return res.json(); })
            .map(function (user) { _this.emitUserLoginEvent(user); })
            .catch(this.handleError);
    };
...
var BooksService = (function () {
    function BooksService(http) {
        this.http = http;
        this.booksUpdate = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["c" /* EventEmitter */]();
    }
    BooksService.prototype.handleError = function (e) {
        console.log("POST ERROR");
        return __WEBPACK_IMPORTED_MODULE_1_rxjs_Observable__["Observable"].throw(e.json().message);
    };
    BooksService.prototype.getBooksUpdate = function () {
        return this.booksUpdate;
    };
    BooksService.prototype.bookSearch = function (a) {
        a = a.split("").join("+");
...
var PostsService = (function () {
    ...
    PostsService.prototype.search = function (a) {
...
/***/ "../../../../../src/app/shelf/shelf.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, ".shelfHolder {\n  width: 50%;\n  border: 2px solid black;\n  opacity: 0.9;\n  margin: 0 auto;\n  margin-top: 50px;\n}\n\n.shelfHolder input {\n  width: 90%;\n  margin: 25px;\n  border: 1px solid black;\n}\n\n.shelfHolder .searchEntries {\n  height: 500px;\n  border: 1px solid black;\n  width: 95%;\n  margin: 0 auto;\n  margin-bottom: 15px;\n}\n", ""]);
...
/***/ "../../../../../src/app/shelf/shelf.component.html":
/***/ (function(module, exports) {

module.exports = "\n\n<div class=\"shelfHolder white\">\n  <input type=\"text\" name=\"search\" class=\"bookSearcher\" placeholder=\"Search for books...\">\n  <div class=\"searchEntries\" *ngFor=\"let book of booklist\">\n    <div class=\"singleSearchEntry\">\n      <li>{{book.title}}</li>\n      <li>{{book.authors}}</li>\n    </div>\n  </div>\n</div>\n"

/***/ }),

/***/ "../../../../../src/app/shelf/shelf.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ShelfComponent = (function () {
    function ShelfComponent(books, auth) {
        var _this = this;
        this.books = books;
        this.auth = auth;
        this.user = this.auth.isLoggedIn();
    ...
    ShelfComponent.prototype.showBooks = function () {
        for (var i = 0; i < 5; i++) {
        }
    };
...
ShelfComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_14" /* Component */])({
        selector: 'app-shelf',
        template: __webpack_require__("../../../../../src/app/shelf/shelf.component.html"),
        styles: [__webpack_require__("../../../../../src/app/shelf/shelf.component.css")]
    }),
